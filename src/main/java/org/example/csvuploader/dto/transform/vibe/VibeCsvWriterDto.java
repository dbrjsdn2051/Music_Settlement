...
public class VibeCsvWriterDto {
    ...
    public static VibeCsvWriterDto of(VibeCsvReadDto dto) throws IllegalAccessException {
        ...
        return VibeCsvWriterDto.builder()
