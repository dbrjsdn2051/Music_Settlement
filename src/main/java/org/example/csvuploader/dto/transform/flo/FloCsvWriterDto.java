...
public class FloCsvWriterDto {
    ...
    public static FloCsvWriterDto of(FloCsvReadDto dto) throws IllegalAccessException {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofPattern("yyyy-MM");
        YearMonth yearMonth = YearMonth.parse(dto.getSettlementMonth().replaceAll("\"", ""), dateTimeFormatter);
        YearMonth plusMonths = yearMonth.plusMonths(1);
        dto = SimpleQuoteRemover.removeSingleQuotes(dto);

        return FloCsvWriterDto.builder()
                .no(dto.getNo())
                .settlementMonth(plusMonths.format(DateTimeFormatter.ofPattern("yyyyMM")))
                .salesMonth(dto.getSalesMonth().replaceAll("\"", "").replace("-", ""))
                ...
                .albumArtistName("\"" + dto.getArtistName() + "\"")
                .upc(dto.getUpc())
